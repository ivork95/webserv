...
for i in range(1000):
    response = requests.get(
        'http://localhost:8081', cookies=cookies, headers=headers)
    response = requests.get(
        'http://localhost:8082', cookies=cookies, headers=headers)
    response = requests.get(
        'http://localhost:8083', cookies=cookies, headers=headers)
